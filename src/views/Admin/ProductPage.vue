    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      >
        <div class="h-52 flex flex-col justify-center items-center bg-blue-600 rounded-t-xl">
          ...
          >
            <rect fill="white" height="56" rx="10" width="56" />
            <path
          ...
          >
            ...
            <defs>
              ...
              <clipPath id="clip0_2204_541">
                <rect fill="white" height="29.5808" transform="translate(12 13.2096)" width="32" />
              </clipPath>
            </defs>
          </svg>
        </div>
      ...
      <button class="btn btn-primary bottom-0" type="button">View More</button>
      <!-- End Card -->
    </div>
  </div>
</template>
