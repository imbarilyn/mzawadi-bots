...
// before loading the sign up page wee fetch the fields required for the signup page
    ...
    >
      <div class="p-4 sm:p-7">
        ...
        <div class="mt-5">
          ...
          <!--                  type="text"-->
          <!--                />-->
          <!--                <small v-if="nameMeta.validated && !nameMeta.valid" class="text-sm text-rose-500">-->
          <!--                  {{ nameErrorMessage }}-->
          <!--                </small>-->
          <!--              </div>-->
          ...
          <!--              <div class="flex flex-col space-y-1">-->
          <!--                <label class="label font-semibold text-sm" for="phone"> Phone </label>-->
          <!--                <input-->
          <!--                  id="phone"-->
          <!--                  v-model="signUpData.phone"-->
          <!--                  :class="{-->
          <!--                    'input-error': phoneMeta.validated && !phoneMeta.valid,-->
          <!--                    'input-primary': phoneMeta.validated && phoneMeta.valid-->
          <!--                  }"-->
          <!--                  class="input input-primary input-bordered w-full text-sm"-->
          <!--                  placeholder="Phone"-->
          <!--                  type="text"-->
          <!--                />-->
          <!--                <small v-if="phoneMeta.validated && !phoneMeta.valid" class="text-sm text-rose-500">-->
          <!--                  {{ phoneErrorMessage }}-->
          <!--                </small>-->
          <!--              </div>-->
