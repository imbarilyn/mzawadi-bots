  ...
  >
    <div class="flex items-center justify-center">
      <svg
        ...
        class="w-6 h-6 group-hover/bar-item:text-gray-800"
        fill="none"
        stroke="currentColor"
        stroke-width="1.5"
        viewBox="0 0 24 24"
      ...
      <svg
        v-else
        :class="
          props.active ? 'text-primary' : 'text-neutral-400 group-hover/bar-item:text-gray-800'
        "
    ...
    <button
      v-if="props.name !== 'Home' && props.name !== 'Settings'"
      class="btn btn-ghost btn-xs btn-square z-30"
      @click.stop="onCloseTabClick"
    >
      <i class="material-icons md-18 text-neutral-400 !text-base"> close </i>
    </button>
  </div>
</template>
